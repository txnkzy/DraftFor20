/**
 * Regenerates supabase/migrations/0044_onepiece.sql.
 *
...
writeFileSync(new URL("../supabase/migrations/0044_onepiece.sql", import.meta.url), sql);
console.log(`wrote 0044_onepiece.sql — ${picked.length} characters, ${picked.length} portraits`);
