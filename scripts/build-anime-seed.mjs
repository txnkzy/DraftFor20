/**
 * Regenerates supabase/migrations/0031_anime_categories.sql.
 *
 *   node scripts/build-anime-seed.mjs
 *
 * Generalises scripts/build-onepiece-seed.mjs (which produced 0029) to a
...
writeFileSync(new URL("../supabase/migrations/0031_anime_categories.sql", import.meta.url), sql);
console.log(`\nwrote 0031_anime_categories.sql — ${built.length} categories, ${built.reduce((n, s) => n + s.picked.length, 0)} characters`);
